...
from drive.Stanford.CS231n_master.assignment2.cs231n.fast_layers import *
...
def affine_relu_forward(x, w, b):
    ...
    """
    # return out, cache = (x, w, b)
    a, fc_cache = affine_forward(x, w, b)
    
    # 經過affine_forward後  a 是 out 經過這一層 後的結果 
    # 用這個當作 relu_forward 的 input     out 是經過relu後的
    # return out, cache = x 
    out, relu_cache = relu_forward(a)
    cache = (fc_cache, relu_cache)
    # out 是經過 dot and relu 後的結果 
    return out, cache
